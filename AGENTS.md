...
- `pnpm run ci`: local equivalent of CI gates (`typecheck`, `lint`, `test`, `build`).
- After every code change, run `pnpm run ci` before creating or updating a PR to ensure CI checks pass.
